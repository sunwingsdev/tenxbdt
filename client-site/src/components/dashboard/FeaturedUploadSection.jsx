...
import FeaturedUploadForm from "./FeaturedUploadForm";

const FeaturedUploadSection = () => {
    ...
    <>
      <div>
        <div className="bg-[#222222] flex flex-row items-start justify-between w-full p-4 mb-2">
          <p className="text-2xl text-white font-bold">Upload Featured Game</p>
          <Button
      ...
      <OppsModal
        title={"Uplaod Featured Game"}
        isOpen={isModalOpen}
        onOpenChange={() => setIsModalOpen(false)}
      >
        <FeaturedUploadForm closeModal={() => setIsModalOpen(false)} />
      </OppsModal>
    </>
  );
};

export default FeaturedUploadSection;
