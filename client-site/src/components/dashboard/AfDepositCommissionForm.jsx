...
const AfDepositCommissionForm = () => {
  ...
  const secoundCommission = allCommissions?.[1];
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            defaultValue={secoundCommission?.commissionValue}
          />
        ...
        <div>
          ...
          <select
            {...register("status")}
            className="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
            defaultValue={secoundCommission?.status}
          >
...
export default AfDepositCommissionForm;
